...
public class  ProtocoloController {
    ...
    //Endpoint para consulta do protocolo através do status
    @GetMapping("/status/{status}")
    public List<Protocolo> listarProtocolosPorStatus(@PathVariable String status) {
        return protocoloService.buscarProtocolosPorStatus(status);
    }
